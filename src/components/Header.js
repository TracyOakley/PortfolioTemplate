  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        ...
        <img src="https://st2.depositphotos.com/3649089/9272/v/600/depositphotos_92724274-stock-illustration-yellow-submarine-undersea.jpg" width="200"  alt="Cartoon Submarine" />
        </a>
